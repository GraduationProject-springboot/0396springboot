...
public class XiangmuLiuyanView extends XiangmuLiuyanEntity implements Serializable {
	...
	public XiangmuLiuyanView() {

	}

	public XiangmuLiuyanView(XiangmuLiuyanEntity xiangmuLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, xiangmuLiuyanEntity);
