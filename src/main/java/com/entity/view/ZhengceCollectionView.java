...
public class ZhengceCollectionView extends ZhengceCollectionEntity implements Serializable {
	...
	*/
	...
	private String zhengceCollectionValue;
	...
	public ZhengceCollectionView() {

	}

	public ZhengceCollectionView(ZhengceCollectionEntity zhengceCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, zhengceCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getZhengceCollectionValue() {
		return zhengceCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setZhengceCollectionValue(String zhengceCollectionValue) {
		this.zhengceCollectionValue = zhengceCollectionValue;
	}
	...
	public String toString() {
		return "ZhengceCollectionView{" +
			", zhengceCollectionValue=" + zhengceCollectionValue +
